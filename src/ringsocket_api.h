...
// This enum is intended for internal RingSocket usage. For app callback return
//values, see enum rs_cb_ret and rs_timer_ret as defined in ringsocket_helper.h.
typedef enum {
    RS_OK = 0,
