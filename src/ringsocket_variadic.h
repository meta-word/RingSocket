...
#define RS_MACRIFY1(identifier, ...) identifier(__VA_ARGS__)
#define RS_MACRIFY2(identifier, ...) identifier(__VA_ARGS__)
#define RS_MACRIFY3(identifier, ...) identifier(__VA_ARGS__)
...
#define RS_PREFIX_EACH(prefix, ...) RS_MACRIFY1(RS_256_256( \
...
#define RS_MACRIFY_EACH(macro, ...) RS_MACRIFY1(RS_256_256( \
